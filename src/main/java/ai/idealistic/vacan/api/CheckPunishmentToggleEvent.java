...
public class CheckPunishmentToggleEvent extends Event implements Cancellable {
   ...
   public CheckPunishmentToggleEvent(CheckEnums.HackType var1, ToggleAction var2) {
      this.ht = var1;
      this.ta = var2;
      this.cancelled = false;
      me.vagdedes.spartan.api.CheckPunishmentToggleEvent var3 = new me.vagdedes.spartan.api.CheckPunishmentToggleEvent(var1, Enums.ToggleAction.valueOf(var2.toString()));
